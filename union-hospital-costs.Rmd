---
title: "Prices at Union Hospital"
author: "Alan Jern"
date: "8/23/2021"
output: 
    html_document:
...
My interpretation of this is that the final column, `Charge` is the result of the end of the negotiation process and is what should be considered the final negotiated "price" of a procedure. The rest of my analysis is based on that assumption.


## Does my own insurance plan save me money? 💵

My insurance plan is Anthem Blue Access PPO. It's part of the Blue Cross Blue Shield association, one of the biggest health insurance companies in the country. Like many people in the US, I get it through my employer and don't really have any other options.
...
Information like this is potentially important for health care consumers to have. But as the NYT article indicates, price discrepancies and inconsistencies are probably more embarrassing for the insurance companies than for the hospitals because the insurers want to be able to claim that they have negotiated competitive prices.

### Can this information be believed?

It's probably hard to be sure. The price that gets charged for medical services surely depends on lots of factors. So I personally wouldn't consider it a guarantee that because an entry in this list shows that a specific procedure is cheaper with no insurance that I'd be better off not using my insurance to get it.
